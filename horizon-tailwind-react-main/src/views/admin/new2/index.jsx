...
const DashboardP1 = () => {
  const [component1CardsP1, setcomponent1CardsP1] = useState([]);
  const [component2CardsP1, setcomponent2CardsP1] = useState([]);
  const [component3CardsP1, setcomponent3CardsP1] = useState([]);
