...
const Dashboard = () => {
  const [component1CardsD, setcomponent1CardsD] = useState([]);
  const [component2CardsD, setcomponent2CardsD] = useState([]);
  const [component3CardsD, setcomponent3CardsD] = useState([]);

  const handleDropComponent1 = (card) => {
    setcomponent1CardsD((prevCards) => prevCards.filter((c) => c.title !== card.title));
    setcomponent2CardsD((prevCards) => prevCards.filter((c) => c.title !== card.title));
    setcomponent3CardsD((prevCards) => prevCards.filter((c) => c.title !== card.title));
    setcomponent1CardsD((prevCards) => [...prevCards, card]);
  };
  ...
  const handleDropComponent2 = (card) => {
    ...
    setcomponent2CardsD((prevCards) => prevCards.filter((c) => c.title !== card.title));
    setcomponent3CardsD((prevCards) => prevCards.filter((c) => c.title !== card.title));
    setcomponent2CardsD((prevCards) => [...prevCards, card]);
  };
  ...
  const handleDropComponent3 = (card) => {
    ...
    setcomponent2CardsD((prevCards) => prevCards.filter((c) => c.title !== card.title));
    setcomponent3CardsD((prevCards) => prevCards.filter((c) => c.title !== card.title));
    setcomponent3CardsD((prevCards) => [...prevCards, card]);
  };
  ...
  const handleAddCard = () => {
    ...
    if (title && description) {
      ...
      setcomponent1CardsD((prevCards) => [...prevCards, newCard]);
    }
  };
